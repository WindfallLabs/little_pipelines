...
class Shell(Cmd):
    ...
    def _default_startup(self, err: str | None=None) -> None:
        """
    ...
    def _default_shutdown(self, err: str | None=None) -> None:
        """
    ...
    def do_has_dependency(self, inp: str) -> None:
        ...
        for task_name in self.pipeline.list_tasks():
            ...
            if dep_name in task.dependencies:
    ...
    def do_info(self, inp: str) -> None:
        ...
        self.console.print(f"[bright_black]{task.script_path}[/]")
    ...
    def _execute(self, inp: str) -> None:
        ...
        upstream: bool = "--no-upstream" not in inputs  # Default True
        downstream: bool = "--no-downstream" not in inputs  # Default True
        # Verbosity / Logging
